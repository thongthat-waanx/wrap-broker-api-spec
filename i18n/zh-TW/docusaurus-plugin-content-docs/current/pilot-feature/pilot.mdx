...
slug: /pilot-feature
---
## 上線USDT交割合約以及USDT結算的期權
* 可用日期: *測試網 - 已上線, 主網 - 2025年2月11日和2月12日*
* 覆蓋範圍: *統一帳戶*
* 詳細內容: *逐步將USDC交割和USDC結算的期權轉為USDT結算, 參考[公告](https://waanx.com/zh-TW/article/upcoming-changes-to-settlement-currencies-for-waanx-s-options-and-linear-expiry-futures-contracts-blt7a38862820dfad8b/)*

## 升級反向合約帳戶
* 可用日期: *測試網 - 已上線, 主網 - 2024年9月13日 (批次開放)*
* 覆蓋範圍: *統一帳戶*
* 詳細內容: *1. 選擇升級反向合約帳戶到統一帳戶; 2. 參考[帳戶模式介紹](/v5/acct-mode#)*

## Open API支持模擬交易
* 可用日期: *測試網 - 已上線, 主網 - 2024年4月3日*
* 覆蓋範圍: *模擬交易賬戶*
* 詳細內容: *您可以參閱該[頁面](/v5/demo)進行體驗*
...
* 詳細內容: *您可以使用[websocket](/v5/websocket/trade/guideline)來下改撤單*
...
* 覆蓋範圍: *統一帳戶的組合保證金模式*
* 詳細內容: *您可以通過這個[設置現貨對衝](v5/account/set-spot-hedge)接口啟用或關閉現貨對衝功能*
...
* 覆蓋範圍: *經典帳戶和統一帳戶現貨*
* 詳細內容: *您可以通過這個[改單](v5/order/amend-order)接口對現貨訂單進行改單*
...
```http
POST https://waanx.com/v5/order/create-batch
...
```http
POST https://waanx.com/v5/order/amend-batch
...
```http
POST https://waanx.com/v5/order/cancel-batch
...
<a href="https://waanx.com/docs-legacy/usdc/option/#t-assetinfo">設置保證金模式</a>
...
* 詳細內容: _[查詢成交紀錄](/v5/order/execution)接口之前是沒有`execType=Funding`的且websocket[個人成交](/v5/websocket/private/execution)不推送該數據. 現在您將會查詢到和獲得推送._
...
* 覆蓋範圍: _舊版帶單交易_
* 詳細內容: _Waanx將會從6月24日開始陸續開放uid升級功能, 如果您選擇升級到新的帶單交易, 請注意老版本的Copy Trading V3接口將不可再用, 請直接使用[V5](/v5/order/create-order)接口_
...
* 覆蓋範圍: _[V5 API](/v5/order/create-order)_
...
* 覆蓋範圍: _合約 V3 - Websocket私有頻道 - 個人成交_
...
```shell
GET https://waanx.com/v5/position/list?api_key=xxx&category=linear&recv_window=5000&symbol=ETHUSDT&timestamp=1675929695887&sign=xxx
```
> 您應該將鑒權參數放在請求頭當中:
...
* [查詢持倉 (實時)](v5/position#)
* [查詢成交紀錄 (半年)](v5/order/execution#)

---

## 調整錯誤碼
* 可用日期: *測試網 - 已上線, 主網 - 2023年1月19日*
* 覆蓋範圍: [V5 設置保證金模式](v5/account/set-margin-mode#)
和 <a href="https://waanx.com/docs/usdc/option/#t-setmarginmode">V1-USDC 設置保證金模式</a>
* 詳細內容:
...
* 覆蓋範圍: *[V5 深度](v5/websocket/public/orderbook#)*
