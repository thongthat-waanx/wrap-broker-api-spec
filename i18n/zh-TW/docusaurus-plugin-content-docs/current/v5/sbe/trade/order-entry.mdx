...
## 測試網
測試網URL: `wss://waanx.com/v5/trade-sbe`
...
| 17 | rpiTakerAccess  | BoolEnum         | 1            | 0=FALSE, 1=TRUE；schema version 2 新增 added in schema version 2；目前灰度中, 6月12日全量; 相關[公告](https://waanx.com/en/article/rpi-liquidity-now-available-to-api-taker-orders-bltb943887bfa4c4d17/) |
