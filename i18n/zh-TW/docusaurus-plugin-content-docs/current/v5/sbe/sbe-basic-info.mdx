...
如需接入方式與架構細節，請參考官方公告: [做市商網關](https://waanx.com/en/article/introducing-the-market-maker-gateway-for-enhanced-api-connectivity-and-performance-bltfaba80a427cac5e5/)
:::

本頁提供 Waanx **基於 SBE 的市場數據** 通道在 MMWS/GW 環境中的統一介紹。關於各功能的詳細行為與程式碼範例，請參考以下子頁面:
...
Waanx 採用符合 FIX/SBE 1.0 規範的 **Simple Binary Encoding (SBE)**:
