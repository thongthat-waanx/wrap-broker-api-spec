...
### HTTP 請求
<APIEndpoint method="GET" url="/v5/crypto-loan-common/loanable-data" />

### 請求參數
| 參數 | 是否必需 | 類型 | 說明|
|:----- |:-------|:-----|------ |
|vipLevel|false|string|Vip等級 <ul><li>`VIP0`, `VIP1`, `VIP2`, `VIP3`, `VIP4`, `VIP5`, `VIP99`(supreme VIP)</li><li>`PRO1`, `PRO2`, `PRO3`, `PRO4`, `PRO5`, `PRO6`</li></ul>|
