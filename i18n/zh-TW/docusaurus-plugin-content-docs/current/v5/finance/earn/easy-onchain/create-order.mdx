...
|amount |**true**| string |<ul><li>質押數量需要滿足最小/最大質押額</li><li>質押和贖回需要滿足幣種精度要求</li></ul>|
|coin |**true**| string |幣種名稱|
|productId |**true**| string |產品ID|
|orderLinkId |**true**| string |自定義訂單號, 同時用於冪等校驗<ul><li>支持最長36位字符</li><li>30分鐘內無法使用相同的orderLinkId</li></ul>|
