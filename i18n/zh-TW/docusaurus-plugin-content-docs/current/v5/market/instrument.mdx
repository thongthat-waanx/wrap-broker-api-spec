...
|baseCoin |false |string |交易貨幣. 僅對期貨/期權有效 <ul><li>對於期權, 默認返回baseCoin為BTC的</li></ul>|
...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> symbolId</td><td>integer</td><td>合約symbol ID </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>> deliveryTime</td><td>string</td><td>交割時間 (ms)<ul><li>交割合約交割時間</li><li>永續合約下架時間</li></ul></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>>> postOnlyMaxOrderQty</td><td>string</td><td>已廢棄, 請參照<code>maxOrderQty</code> </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>> forbidUplWithdrawal</td><td>boolean</td><td>是否禁止浮盈提現</td>
        </tr>
        <tr>
            <td>> riskParameters</td><td>object</td><td>限價單價格風控參數, 參讀該<a href="https://waanx.com/en/article/update-contract-price-limit-enhancement-bltf9ebdcebe3089641/">公告內容</a>（2026年5月更新）</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>> isPreListing</td><td>boolean</td><td><ul><li>該合約是否為盤前合約</li><li>當盤前合約轉為正式合約後, 值將變成false</li></ul></td>
        </tr>
        <tr>
            <td>> preListingInfo</td><td>object</td><td><ul><li>如果isPreListing=false, preListingInfo=null</li><li>如果isPreListing=true, preListingInfo是object</li></ul> </td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            <td>>>> auctionFeeRate</td><td>string</td><td>集合競價期間的手續費率 <ul><li>目前, 僅在連續競價期間才會產生手續費</li></ul></td>
        </tr>
         <tr>
        ...
        <tr>
            <td>>> skipCallAuction</td><td>boolean</td><td><code>false</code>, <code>true</code> 是否跳過集合競價階段</td>
        </tr>
    </table>
</TabItem>
...
<TabItem value="option" label="Option">
    <table border="0.8">
        ...
        <tr>
            <td>> symbolId</td><td>integer</td><td>期權symbol ID </td>
        </tr>
        <tr>
...
<TabItem value="spot" label="Spot">
    <table border="0.8">
        ...
        <tr>
         ...
         <tr>
            <td>> symbolId</td><td>integer</td><td>現貨交易對ID </td>
        </tr>
        <tr>
            <td>> symbol</td><td>string</td><td>現貨交易對名稱 </td>
        </tr>
        <tr>
            <td>> baseCoin</td><td>string</td><td>交易幣種 </td>
        </tr>
        ...
        <tr>
            <td>> xstockMultiplier</td><td>string</td><td>股票代幣係數<li>僅適用於"symbolType"=<code>xstocks</code>交易對<br/>關係: 股票價格 = 代幣價格 / 係數; 股票數量 = 代幣數量 * 係數</li><li>默認值: "1"</li></td>
        </tr>
        <tr>
            <td>> <a href="../enum#status">status</a></td><td>string</td><td>合約狀態 </td>
        </tr>
        <tr>
         ...
         <tr>
            <td>> stTag</td><td>string</td><td>幣對是否存在<a href="https://waanx.com/en/help-center/article/Waanx-Special-Treatment-ST-Label-Management-Rules">特殊處理(ST)標籤</a>. <code>0</code>: 否, <code>1</code>: 是 </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>> riskParameters</td><td>Object</td><td>限價單價格風控參數, 參讀該<a href="https://waanx.com/zh-TW/article/title-adjustments-to-waanx-s-spot-trading-limit-order-mechanism-blt786c0c5abf865983/">公告內容</a></td>
        </tr>
        <tr>
