...
---
現在Waanx平台上共有三種帳戶模式並存, 分別是經典帳戶, 統一帳戶1.0, 統一帳戶2.0
...
<table>
    ...
    <tr>
        <td><a href="abandon/cross-isolate#">切換全倉/逐倉保證金</a></td><td>保證金模式變成帳戶維度了, 該接口不再適用</td><td>反向合約支持使用該接口</td>
    </tr>
    <tr>
    ...
    <tr>
        <td><a href="abandon/contract-transaction-log#">交易日誌(經典帳戶)</a></td><td>升級到2.0後, 該接口就不適用了</td><td>在1.0或者經典時的數據還能取到</td>
    </tr>
    <tr>
