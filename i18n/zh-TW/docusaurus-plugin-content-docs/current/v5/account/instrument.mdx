...
<TabItem value="linear" label="Linear/Inverse" default>
    <table border="0.8">
        ...
        <tr>
            <td>> isPublicRpi </td><td>boolean</td><td>是否公開給做市商進行 RPI<ul><li> true: 公開給做市商進行 RPI</li> <li>false: 没有公開給做市商進行 RPI</li></ul> </td>
        </tr>
        <tr>
            <td>> myRpiPermission </td><td>boolean</td><td>當前使用者是否有RPI權限<ul><li> true: 有RPI權限</li> <li>false: 没有有RPI權限</li></ul> </td>
        </tr>
    </table>
</TabItem>
