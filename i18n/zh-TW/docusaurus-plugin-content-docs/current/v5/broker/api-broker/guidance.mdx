...
## 1. 信息提交
通过邮箱（broker_program@waanx.com）向 Waanx 商務提交以下信息：
...
1. **登陸 Waanx**  
   使用對應的 UID 登陸 Waanx 賬戶

2. **訪問管理後台**  
   打開連結：https://waanx.com/app/user/oauth-admin  
   - 設定 Application Name
   - 設定 Email
   - 上傳 Logo
   - 其他相關操作  
...
### 1. 拼接授權頁面
```bash
https://waanx.com/en/oauth/en/oauth?
client_id={client_id}&
response_type=code&
...
| `scope` | 權限範圍 | 傳 `openapi`（其他值需與 Waanx 確認） |
