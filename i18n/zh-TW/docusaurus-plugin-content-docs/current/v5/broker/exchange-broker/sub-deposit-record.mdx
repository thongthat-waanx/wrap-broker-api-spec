...
|> taxDepositRecordsId|string|Waanx EU（奧地利）用戶用於稅務目的, 保稅記錄id |
|> taxStatus|integer|Waanx EU（奧地利）用戶用於稅務目的 <ul><li>0: No reporting required</li><li>1: Reporting pending</li><li>2: Reporting completed</li></ul>|
