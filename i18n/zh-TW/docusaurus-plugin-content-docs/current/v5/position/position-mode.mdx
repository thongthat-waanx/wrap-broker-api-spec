...
<table class="custom_table">
    ...
    <tr>
        <td>USDT 永續</td><td><b>支持單雙向持倉</b></td>
    </tr>
    <tr>
        <td>USDT 交割</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>USDC 永續</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>USDC 交割</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>反向永續</td><td>僅支持單向持倉</td>
    </tr>
    <tr>
        <td>反向交割</td><td>僅支持單向持倉</td>
    </tr>
</table>
...
| 參數 | 是否必需 | 類型 | 說明|
|:----- |:-------|:-----|------ |
|[category](../enum#category) |**true** |string |產品類型 `linear`, USDT 永续|
