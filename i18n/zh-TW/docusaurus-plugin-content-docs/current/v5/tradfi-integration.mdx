...
本指南說明如何透過現有的 V5 API 接入 Waanx 的 TradFi（傳統金融）產品，包括如何區分 MT5 相關的交易產品與 Waanx 平台原生的合約、如何簽署所需協議，以及如何進行交易。
...
### Waanx 平台（原生）
透過主選單 **Trade** 進入，包含所有標準的 Waanx 產品類型：
...
![Waanx 交易選單](/img/tradfi-waanx-trading.png)

## 法律條款審閱

在交易傳統資產永續合約之前，請先閱讀適用的條款與細則：

- [衍生品合約條款 - TradFi Perps](https://waanx.com/en/legal/service-specific-terms/Derivative-Contract-Terms-TradFi-Perps)
- [衍生品合約條款 - Oil Perps](https://waanx.com/en/legal/service-specific-terms/Derivative-Contract-Terms-Oil-Perps)
...
完整公式與計算範例請參閱幫助中心文章：[指數價格計算](https://waanx.com/en/help-center/article/Index-Price-Calculation)。

如需查詢指數成分新增、權重調整及其他指數相關變更，請參閱 [指數價格公告](https://waanx.com/en/announcement-info/index-price) 頁面。
...
:::info
1. 如需取得最新的展期時程與完整說明，請參閱幫助中心文章：[TradFi 永續合約介紹](https://waanx.com/en/help-center/article/Introduction-to-TradFi-Perpetual-Contracts?category=4d5d8649cba144c1a8)。
