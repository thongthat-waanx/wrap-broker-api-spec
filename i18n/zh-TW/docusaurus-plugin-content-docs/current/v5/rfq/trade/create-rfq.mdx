...
|list |true |array of objects |組合交易清單 <ul><li>通過 <a href="/zh-TW/v5/rfq/trade/rfq-config">rfq配寘資訊</a> 確認所提供的最大腿數 (`maxLegs`)</li><li>所有組合的 basecoin 和 settleCoin 必須相同</li><li>同類型下的 symbol 必須唯一</li></ul>|
