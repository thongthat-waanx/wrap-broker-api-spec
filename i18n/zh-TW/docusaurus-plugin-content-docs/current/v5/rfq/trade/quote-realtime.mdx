---
title: 獲取即時報價
sidebar_label: 獲取即時報價
sidebar_position: 11
---
獲取即時報價資訊。**每秒最多 50 次請求**  
:::info
<ul><li>獲取使用者發送或接收的報價資訊，從 rfq-engine 查詢，無延遲</li>
<li>同時傳遞 quoteId 和 quoteLinkId 時，以 quoteId 為準，優先順序：quoteId > quoteLinkId > rfqId</li>
<li>根據報價的創建時間倒序排列</li>
<li>返回所有非最終報價</li>
<li>在極端市場波動期間, 此介面可能會出現延遲增加或資料傳遞暫時延遲的情況</li></ul>
:::

### HTTP 請求
<APIEndpoint method="GET" url="/v5/rfq/quote-realtime" />
