...
取消報價單。**每秒最多 50 次請求**
:::info
<ul><li>至少需傳遞 quoteId、rfqId 或 quoteLinkId。</li><li>若同時傳遞 quoteId、rfqId 和 quoteLinkId，則優先以 quoteId 為準，優先順序判斷為：quoteId > quoteLinkId > rfqId。</li></ul>
:::

### HTTP 請求
<APIEndpoint method="POST" url="/v5/rfq/cancel-quote" />
