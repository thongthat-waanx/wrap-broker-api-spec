...
|> balance | string	| 總資產(保證金幣種資產折算為USDT資產). 可以參考<a href="https://waanx.com/zh-MY/help-center/s/article/Over-the-counter-OTC-Lending">這裡</a>了解詳細計算 |
...
```http
curl --location --request GET 'https://waanx.com/spot/v3/private/margin-ltv' \
