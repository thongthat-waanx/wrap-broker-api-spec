...
a. 當請求到api.waanx.com或者stream.waanx.com時, 請確保api key創建自[主網](https://waanx.com)
![主網示意圖](/img/prd.png)
```python
# pybit示例
session = HTTP(
...
```
---
b. 當請求到api-demo.waanx.com或者stream-demo.waanx.com時, 請確保api key創建自[主網](https://waanx.com)的"模擬交易"服務
...
```
---
c. 當請求到api-testnet.waanx.com或者stream-testnet.waanx.com時, 請確保api key創建自[測試網](https://waanx.com)
![測試網示意圖](/img/test.png)
```python
# pybit示例
session = HTTP(
...
使用母帳戶登錄後, 進入到該[頁面](https://waanx.com/user/assets/home/overview), 右邊有個"申請測試幣"按鈕
