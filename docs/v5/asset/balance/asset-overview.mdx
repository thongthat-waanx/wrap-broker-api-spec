...
### HTTP Request
<APIEndpoint method="GET" url="/v5/asset/asset-overview" />
...
|[accountType](../../enum#assetaccounttype) |false |string |Account type.  Returns all if not passed |
