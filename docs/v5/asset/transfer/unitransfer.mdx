...
### HTTP Request
<APIEndpoint method="POST" url="/v5/asset/transfer/universal-transfer" />
...
|status |string|Transfer status <ul><li>`STATUS_UNKNOWN`</li><li>`SUCCESS`</li><li>`PENDING`</li><li>`FAILED`</li></ul> |
