...
---
Query deposit records within the Waanx platform. These transactions are not on the blockchain.
...
### HTTP Request
<APIEndpoint method="GET" url="/v5/asset/deposit/query-internal-record" />
...
|> taxDepositRecordsId|string|This field is used for tax purposes by Waanx EU (Austria) users, declare tax id|
|> taxStatus|integer|This field is used for tax purposes by Waanx EU (Austria) users <ul><li>0: No reporting required</li><li>1: Reporting pending</li><li>2: Reporting completed</li></ul>|
