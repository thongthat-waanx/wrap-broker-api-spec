...
### HTTP Request
<APIEndpoint method="GET" url="/v5/earn/position" />
...
|> autoReinvest|string |Auto-reinvest status. `Enable`: enabled, `Disable`: disabled. See [Modify Position](modify-position.mdx)|
