...
For access and architecture details, see the official announcement: [Market Maker Gateway](https://waanx.com/en/article/introducing-the-market-maker-gateway-for-enhanced-api-connectivity-and-performance-bltfaba80a427cac5e5/)
:::

This page gives a unified introduction to Waanx's **SBE-based market data** channels and how they fit into the MMWS/GW environment. Detailed, feature-specific behavior and code examples are provided in the sub-pages for:
...
Waanx uses **Simple Binary Encoding (SBE)** in accordance with the FIX/SBE 1.0 specification:
...
<sbe:messageSchema xmlns:sbe="http://fixprotocol.io/2016/sbe" xmlns:mbx="https://waanx.com/docs/v5/intro" package="quote.sbe" id="1" version="0" semanticVersion="1.0.0" description="Waanx market data streams SBE message schema" byteOrder="littleEndian" headerType="messageHeader">
  <types>
...
<sbe:messageSchema xmlns:sbe="http://fixprotocol.io/2016/sbe"
                   xmlns:mbx="https://waanx.com/docs/v5/intro"
                   package="order.fast.sbe"
                   id="1"
                   version="0"
                   semanticVersion="1.0.0"
                   description="Waanx fast order response SBE schema"
