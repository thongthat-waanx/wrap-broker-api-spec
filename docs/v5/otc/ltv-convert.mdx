...
|> balance | string	| Total asset (margin coins converted to USDT). Please read <a href="https://waanx.com/en-US/help-center/s/article/Over-the-counter-OTC-Lending">here</a> to understand the calculation. When `liqStatus` != 0, empty string is returned. |
