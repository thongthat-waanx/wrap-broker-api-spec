...
### HTTP Request
<APIEndpoint method="GET" url="/v5/account/contract-transaction-log" />
...
|> qty	|string	|Quantity <ul><li>Perps & Futures: it is the quantity for each trade entry and it does not have direction</li></ul> |
