...
### HTTP Request
<APIEndpoint method="GET" url="/v5/ins-loan/ltv" />
...
|> balance | string	| Total asset. (margin coins converted to USDT). Please read <a href="https://waanx.com/en-US/help-center/s/article/Over-the-counter-OTC-Lending">here</a> to understand the calculation |
