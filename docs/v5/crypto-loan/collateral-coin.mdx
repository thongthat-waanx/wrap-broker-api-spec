...
### HTTP Request
<APIEndpoint method="GET" url="/v5/crypto-loan/collateral-data" />
...
|>> liquidationLTV|string |If the LTV ratio (Loan Amount/Collateral Amount) reaches the threshold, Waanx will liquidate your collateral assets to repay your loan and interest in full|
