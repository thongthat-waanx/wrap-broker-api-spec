...
sidebar_position: 10
---
You can increase or reduce your collateral amount. When you reduce, please obey the <a href="https://waanx.com/docs/v5/crypto-loan/reduce-max-collateral-amt">max. allowed reduction amount</a>.
...
### HTTP Request
<APIEndpoint method="POST" url="/v5/crypto-loan/adjust-ltv" />
