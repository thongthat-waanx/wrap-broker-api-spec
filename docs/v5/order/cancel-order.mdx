...
### HTTP Request
<APIEndpoint method="POST" url="/v5/order/cancel" />
...
|orderFilter |false |string |Spot trading **only**<ul><li>`Order`</li><li>`tpslOrder`</li><li>`StopOrder`</li></ul>If not passed, `Order` by default|
