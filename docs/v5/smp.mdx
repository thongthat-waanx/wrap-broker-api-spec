...
You can contact your institutional business manager or email Waanx via: institutional_services@waanx.com

## SMP across Waanx Global vs. Waanx compliant sites

- **Waanx Global:** Institutional clients can choose whether to enable SMP.
- **Waanx compliant sites:** SMP is **enabled by default for all users**.
  - **Note:** Most compliant sites currently support **spot trading only**.

**Rollout schedule**:<br/>

The first site to go live will be **Waanx Turkey**, followed by:
- **Turkey:** 2026/01/27
