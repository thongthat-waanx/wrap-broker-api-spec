...
### HTTP Request
<APIEndpoint method="POST" url="/v5/broker/award/distribute-award" />
...
|amount |**true** |string |Issue amount <ul><li>Spot airdrop supports up to 16 decimals</li><li>Other types supports up to 4 decimals</li></ul> |
