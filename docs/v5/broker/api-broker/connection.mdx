...
Use the dedicated hostname provided by Waanx with the same V5 WebSocket path structure:
...
For questions about broker eligibility, contact `broker_program@waanx.com`.

## Application process

After approval from your Broker Account Manager, contact `api_services@waanx.com` or your dedicated broker support group with:
...
3. Submit the application details through your Broker Account Manager, `api_services@waanx.com`, or your dedicated broker support group.
4. After approval, replace the public hostname with the dedicated hostname provided by Waanx for supported paths.
