...
:::info
* Turkey users registered from "www.waanx.com", please use `wss://waanx.com/v5/trade`
* Kazakhstan users registered from "www.waanx.com", please use `wss://waanx.com/v5/trade`
:::
...
|> X-BAPI-RECV-WINDOW|false |string |5000(ms) by default. Request will be rejected when not satisfy this rule: <i>Waanx_server_time - X-BAPI-RECV-WINDOW <= X-BAPI-TIMESTAMP < Waanx_server_time + 1000</i>|
