...
---
Subscribe to the liquidation stream, push all liquidations that occur on Waanx.
...
|> p |string |<a href="https://waanx.com/en-US/help-center/s/article/Bankruptcy-Price-USDT-Contract">Bankruptcy price</a> |
