...
- **Mainnet:**<br/>
Spot: `wss://waanx.com/v5/public/spot`<br/>
USDT, USDC perpetual & USDT Futures: `wss://waanx.com/v5/public/linear`<br/>
Inverse contract: `wss://waanx.com/v5/public/inverse`<br/>
Spread trading: `wss://waanx.com/v5/public/spread`<br/>
RFQ: `wss://waanx.com/v5/public/rfq`<br/>
USDT/USDC Options: `wss://waanx.com/v5/public/option`
...
- **Mainnet:**<br/>
`wss://waanx.com/v5/trade` (Spread trading is not supported)
...
- **Mainnet:**<br/>
`wss://waanx.com/v5/public/misc/status`

- **Testnet:**<br/>
`wss://waanx.com/v5/public/misc/status`

:::info
* If your account is registered from www.waanx.com, please use `stream.waanx.com` for mainnet access
* If your account is registered from www.waanx.com, please use `stream.waanx.com` for mainnet access
* If your account is registered from www.waanx.com, please use `stream.waanx.com` for mainnet access
:::

:::tip Customise Private Connection Alive Time
For private stream and order entry, you can customise alive duration by adding a param `max_active_time`, the lowest value is `30s` (30 seconds), the highest value is `600s` (10 minutes). You can also pass `1m`, `2m` etc when you try to configure by minute level. e.g., <i>wss://waanx.com/v5/private?max_active_time=1m</i>.
...
<p>Note: if you're using a high-level library, you can ignore this code when authentication is handled for you.</p>
