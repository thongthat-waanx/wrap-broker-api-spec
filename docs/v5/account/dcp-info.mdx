...
:::info
* Support USDT Perpetuals, USDT Futures, USDC Perpetuals, USDC Futures, Inverse Perpetuals, Inverse Futures [DERIVATIVES]<br/>Spot [SPOT]<br/>Options [OPTIONS]
:::

### HTTP Request
<APIEndpoint method="GET" url="/v5/account/query-dcp-info" />
