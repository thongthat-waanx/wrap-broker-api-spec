...
## How to enable MMP
Send an email to Waanx (financial.inst@waanx.com) or contact your business development (BD) manager to apply for MMP.
...
|vegaLimit |string |Vega limit| 500000 |
...
### HTTP Request
<APIEndpoint method="POST" url="/v5/account/mmp-modify" />
...
|vegaLimit |false |string |Vega limit (positive and up to 2 decimal places). Default: `500000`|
