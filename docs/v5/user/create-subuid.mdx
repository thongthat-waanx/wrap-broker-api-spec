...
### HTTP Request
<APIEndpoint method="POST" url="/v5/user/create-sub-member" />
...
|memberType |<b>true</b> |integer |`1`: normal subaccount, `6`: [custodial subaccount](https://waanx.com/en/help-center/article?id=000001683)|
...
|memberType |integer |`1`: normal subaccount, `6`: [custodial subaccount](https://waanx.com/en/help-center/article?id=000001683)|
