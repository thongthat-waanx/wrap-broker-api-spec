...
### HTTP Request
<APIEndpoint method="GET" url="/v5/user/get-member-type" />
...
|> [accountType](../enum#accounttype) |array |Wallets array. `FUND`,`UNIFIED`|
...
```n4js
// https://waanx.com/v5/user/get-member-type
