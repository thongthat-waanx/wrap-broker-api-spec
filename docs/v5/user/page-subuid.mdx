...
### HTTP Request
<APIEndpoint method="GET" url="/v5/user/submembers" />
...
|> memberType |integer |`1`: standard subaccount, `6`: [custodial subaccount](https://waanx.com/en/help-center/article?id=000001683) |
