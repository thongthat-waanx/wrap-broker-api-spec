...
### HTTP Request
<APIEndpoint method="GET" url="/v5/user/query-api" />
...
|> FiatBitPay |array |Permission of Waanx Pay `FaitPayOrder`. Not applicable to subaccount, always `[]`|
|> FiatConvertBroker |array |Permission of fiat convert `FiatConvertBrokerOrder`. Not applicable to subaccount, always `[]`|
|> BitCard |array |Waanx card permission, `BitCard`. Not applicable to subaccount|
