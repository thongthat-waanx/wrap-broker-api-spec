...
### HTTP Request
<APIEndpoint method="POST" url="/v5/spread/order/create" />
...
|timeInForce |false |string |<a href="https://waanx.com/en/help-center/article/What-Are-Time-In-Force-TIF-GTC-IOC-FOK">Time in force</a>. `IOC`, `FOK`, `GTC`, `PostOnly`|
