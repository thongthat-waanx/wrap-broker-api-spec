...
### HTTP Request
<APIEndpoint method="GET" url="/v5/spread/orderbook" />
...
|u |integer |Update ID. Is always in sequence. Corresponds to `u` in the 25-level [WebSocket orderbook stream](https://waanx.com/docs/v5/spread/websocket/public/orderbook)|
