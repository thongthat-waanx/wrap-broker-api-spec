...
## Overview
The V5 API brings uniformity and efficiency to Waanx's product lines, unifying Spot, Derivatives, and Options in one
...
<table class="custom_table">
    ...
    <tr>
        <td><b>USDT Perpetual</b></td><td><b>USDC Perpetual</b></td><td><b>USDT Futures</b></td><td><b>Perpetual</b></td><td><b>Futures</b></td>
    </tr>
    <tr>
...
Example: api.waanx.com/v5/market/recent-trade
