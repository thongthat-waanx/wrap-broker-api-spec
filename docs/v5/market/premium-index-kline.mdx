...
Query for historical <a href="https://waanx.com/data/basic/linear/index-price/premium-index?symbol=BTCUSDT">premium index</a> klines. Charts are returned in groups based on the requested interval.
> **Covers: USDT and USDC perpetual**

### HTTP Request
<APIEndpoint method="GET" url="/v5/market/premium-index-price-kline" />
...
client.NewUtaWaanxServiceWithParams(params).GetPremiumIndexPriceKline(context.Background())
```
