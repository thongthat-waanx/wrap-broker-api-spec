...
Query for the [group fee structure](https://waanx.com/en/help-center/article/Group-Fee-Structure-Symbol-Grouping) and fee rates.

:::note
The new grouped fee structure only applies to Pro-level and Market Maker clients. It does not apply to retail traders.
:::

For more details please refer to the [fee structure update announcement](https://waanx.com/article/waanx-fee-structure-update-for-pro-and-market-maker-clients-blt06875b6d623e7581/).
...
* **Weighted maker share** = (Your total weighted maker volume ÷ Waanx's total weighted maker volume)
* *Note: Waanx's total weighted maker volume is not provided by the API. Weighted maker share will be provided in the monthly MM report*.
:::
