...
Starting **August 13, 2025**, Waanx will roll out a new institutional API rate limit 
...
configurations, enabling greater efficiency and scalability. Please refer to the [announcement](https://waanx.com/en/article/update-waanx-enhances-api-rate-limits-for-institutional-traders-bltbbbf60de757d074e/) for more information.
:::
