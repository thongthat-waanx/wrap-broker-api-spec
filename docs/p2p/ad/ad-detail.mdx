---
title: Get My Ad Details
sidebar_label: Get My Ad Details
sidebar_position: 6
---
...
|priceType|integer|Ad pricing model. `0`: fixed price; `1`: floating price|
|price|string|Ad price|
|premium|string|The premium applied to the reference price. E.g, a value of 130 means 130% of the reference price|
|lastQuantity|string|Remaining tradable quantity of ad|
|quantity|string|Quantity of token|
|frozenQuantity|string|Frozen quantity of token for ongoing transactions|
...
|version|integer|Ad version, a way of posting advertisements that existed in the past, is divided into two types: pre-freezing funds for posting advertisements and not pre-freezing funds for posting advertisements.<br/>`1`: pre-freezing funds; `2`: not pre-freezing funds|
|paymentPeriod|integer|Payment period (unit: minutes)|
|itemType|string|`ORIGIN`: original P2P advertisement, generally refers to non-bulk advertisements <br/>`BULK`: bulk advertisement|
