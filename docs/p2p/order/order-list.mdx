...
:::info
Returns 90 days of orders by default. Orders are accessible up to 180 days in the past.
:::
...
|size|**true**|integer|Rows to query per page, max is 30|
...
|side|false|integer|`0`: Buy, `1`: Sell|
