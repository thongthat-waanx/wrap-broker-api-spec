...
- [Get Product List](../v5/finance/rwa/product) [NEW]
- [Place Order](../v5/finance/rwa/place-order) [NEW]
- [Get Position List](../v5/finance/rwa/position) [NEW]
- [Get Order List](../v5/finance/rwa/order) [NEW]
- [Get NAV Chart](../v5/finance/rwa/nav-chart) [NEW]
...
- [Questionnaire](../v5/asset/withdraw/questionnaire) [NEW]
...
- [Submit Deposit Originator Info](../v5/asset/deposit/submit-info) [NEW]
...
- [Get Fee Group Structure](../v5/market/fee-group-info) [UPDATE]
    - Add a new fee group `groupId`="9", G9(TradFi). There are no symbols in this group until June 16, 2026

## 2026-06-09
### REST API
- [Set MMP](../v5/account/set-mmp) [UPDATE]
    - Add new optional request parameter `vegaLimit` (vega limit, default: `500000`)
- [Get MMP State](../v5/account/get-mmp-state) [UPDATE]
    - Add new response field `vegaLimit`
- [Reset MMP](../v5/account/reset-mmp) [UPDATE]
    - `vegaLimit` will also be reset to `0` upon reset

## 2026-06-03
- [Place Order](../v5/order/create-order) [UPDATE]
    - add a new request parameter `rpiTakerAccess`, this feature is currently in a gradual rollout phase and will be fully available on 12 June.

### Websocket API
- [SBE Order Entry](../v5/sbe/trade/order-entry) [UPDATE]
    - Update the xml template from version=1 to version=2, please see [template](../v5/sbe/sbe-basic-info#ws-order-entry-sbe-xml-template)
    - Add a new request parameter `rpiTakerAccess`, this feature is currently in a gradual rollout phase and will be fully available on 12 June.
...
## 2026-05-28
### REST API
- [Get Crypto Loan Position](../v5/new-crypto-loan/crypto-loan-position) [UPDATE]
...
## 2026-05-26
### REST API
- [Strategy](../v5/strategy/create-strategy) [UPDATE]
...
## 2026-05-22
### REST API
- [Get Airdrop Products](../v5/finance/earn/hold-to-earn/product)
    - Add Byfi airdrop product endpoint

- [Get Airdrop Daily PnL Records](../v5/finance/earn/hold-to-earn/yield-history)
    - Add Byfi airdrop daily pnl record endpoint

**PWM (Private Wealth Management) — New Endpoints**
- [Get All Investment Plans](../v5/finance/pwm/investment-plan/all) [NEW]
- [Get Investment Plan Detail](../v5/finance/pwm/investment-plan/detail) [NEW]
- [Get Pending Investment Plan Detail](../v5/finance/pwm/investment-plan/new-plan) [NEW]
- [Claim Withdrawable Funds](../v5/finance/pwm/investment-plan/claim) [NEW]
- [Get Asset Trend](../v5/finance/pwm/investment-plan/asset-trend) [NEW]
- [Get Fund Historical NAV](../v5/finance/pwm/investment-plan/fund-nav) [NEW]
- [Subscribe Investment Plan](../v5/finance/pwm/investment-plan/subscribe) [NEW]
- [Invest More](../v5/finance/pwm/investment-plan/invest-more) [NEW]
- [Redeem](../v5/finance/pwm/investment-plan/redeem) [NEW]
- [Get Investment Plan Orders](../v5/finance/pwm/investment-plan/order) [NEW]
- [Get Subscribable Product Info](../v5/finance/pwm/customize-plan/product) [NEW]
- [Create Customize Investment Plan](../v5/finance/pwm/customize-plan/create) [NEW]
- [Get All Funds](../v5/finance/pwm/asset-manager/all-funds) [NEW]
- [Settle Fund Profit](../v5/finance/pwm/asset-manager/settle-profit) [NEW]
- [Create Fund](../v5/finance/pwm/asset-manager/create-fund) [NEW]
- [Create Investment Plan](../v5/finance/pwm/asset-manager/create-investment-plan) [NEW]
- [Get Investment Plans](../v5/finance/pwm/asset-manager/get-investment-plan) [NEW]
- [Manage Investment Plan](../v5/finance/pwm/asset-manager/manage-investment-plan) [NEW]
- [Get All Fund Orders](../v5/finance/pwm/asset-manager/all-order) [NEW]
- [Manage Order](../v5/finance/pwm/asset-manager/manage-order) [NEW]
- [Create Fund Sub-Account](../v5/finance/pwm/asset-manager/create-sub-account) [NEW]
- [Fund Transfer Between Sub-Accounts](../v5/finance/pwm/fund-transfer) [NEW]
- [Get Fund Transfer Records](../v5/finance/pwm/query-fund-transfer-result) [NEW]
...
- [Get Affiliate Sub-Affiliate List](../v5/affiliate/affiliate-sub-list) [NEW]
    - Add a new endpoint to query sub affiliates
- [Get API Key Information](../v5/user/apikey-info) [UPDATE]
    - Remove `FiatWaanxPay` key from the response
...
## 2026-05-07
### REST API
- [Get Staked Position](../v5/finance/earn/easy-onchain/position) [UPDATE]
...
## 2026-05-06
### REST API
- [Create Supply Order](../v5/new-crypto-loan/fixed/supply) [UPDATE]
...
- [Cancel Supply Order](../v5/new-crypto-loan/fixed/cancel-supply) [UPDATE]
...
- [Get Account Instruments Info](../v5/account/instrument) [UPDATE]
...
## 2026-04-27
### REST API
- [Strategy](../v5/strategy/create-strategy) [NEW]
    - Add strategy open APIs

## 2026-04-23
### REST API
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - Add new field `symbolId` (spot)
- [Get Account Instruments Info](../v5/account/instrument) [UPDATE]
    - Add new field `symbolId` (spot)
...
- [Get Affiliate User Info](../v5/affiliate/affiliate-info) [UPDATE]
    - Add new response fields: `paySendAmount30Day`, `payFtt`, `cardFtt`
...
- [Get Position Info](../v5/position) [UPDATE]
    - Add `openTime`
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - Add new `symbolType` enum values: `stock` (linear), `forex` (linear)
- [Get Account Instruments Info](../v5/account/instrument) [UPDATE]
    - Add new `symbolType` enum values: `stock` (linear), `forex` (linear)
...
## 2026-04-20
### REST API
- [Sign Agreement](../v5/user/sign-agreement) [UPDATE]
    - Add new request parameter `categoryV2`. New enum values will be added to `categoryV2` going forward; the existing `category` field remains supported

## 2026-04-17
### REST API
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - add a new required request param `transactionPurpose` for Waanx Turkey site users

## 2026-04-16
### REST API
- Waanx Card adds new endpoints [NEW]
    - [Query Asset Records](../v5/waanx-card/asset-records) [NEW]
    - [Query Point Balance](../v5/waanx-card/point/balance) [NEW]
    - [Query Point Records](../v5/waanx-card/point/records) [NEW]
    - [Query Tier Info](../v5/waanx-card/point/tier) [NEW]
    - [Query Mall Item List](../v5/waanx-card/point/item-list) [NEW]
    - [Query Cashback Detail](../v5/waanx-card/point/cashback-detail) [NEW]

## 2026-04-14
### REST API
- Earn adds new produc [UPDATE]
    - [Fixed Saving](../v5/finance/earn/fixed-saving/product) [NEW]

- Advanced-Earn adds new product [UPDATE]
    - [Discount Buy](../v5/finance/advanced-earn/discount-buy/product-info) [NEW]

## 2026-04-10
### REST API
- Advanced-Earn adds new product [UPDATE]
    - [Liquidity Mining](../v5/finance/advanced-earn/liquidity-mining/product-info) [NEW]

## 2026-04-09
### REST API
- [Manual Repay](../v5/account/repay) [UPDATE]
- [Manual Repay Without Asset Conversion](../v5/account/no-convert-repay) [UPDATE]
    - Add new request parameter `repaymentType` to specify whether to repay fixed-rate, floating-rate, or both liabilities
- [Get Liability Info](../v5/spot-margin-uta/liability) [NEW]
...
- [Fixed-Rate Borrow](../v5/spot-margin-uta/fixedborrow) [NEW]
...
- [Get Fixed-Rate Borrow Order Info](../v5/spot-margin-uta/fixedborrow-order-info) [NEW]
    - Add a new endpoint to query fixed-rate borrow order history with filtering by order ID, coin, status, and term
- [Get Fixed-Rate Borrow Contract Info](../v5/spot-margin-uta/fixedborrow-contract-info) [NEW]
...
- [Get Fixed-Rate Borrow Order Quote](../v5/spot-margin-uta/fixedborrow-order-quote) [NEW]
    - Add a new endpoint to query available fixed-rate borrow quotes with sorting by annual rate, term, or quantity
- [Renew Fixed-Rate Borrow](../v5/spot-margin-uta/fixedborrow-renew) [NEW]
    - Add a new endpoint to renew a fixed-rate borrow contract, supporting full or partial renewal by quantity
- [Get API Key Information](../v5/user/apikey-info) [UPDATE]
    - Add new response field `FiatBitPay` under `permissions`. The old field `FiatWaanxPay` remains available during the transition period
- [Modify Master API Key](../v5/user/modify-master-apikey) [UPDATE]
    - Add new request parameter `FiatBitPay` under `permissions`. The old field `FiatWaanxPay` remains available during the transition period

## 2026-04-08
### REST API
- Support a new earn product [UPDATE]
    - [BYUSDT](../v5/finance/earn/byusdt/product) [NEW]

## 2026-04-07
### REST API
- Advanced-Earn adds two new products [UPDATE]
    - [Smart Leverage](../v5/finance/advanced-earn/smart-lvg/product-info) [NEW]
    - [Double Win](../v5/finance/advanced-earn/double-win/product-info) [NEW]
...
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - `accountType` now supports Earn account

- [Get Delay Withdraw Amount](../v5/asset/balance/delay-amount) [UPDATE]
    - Support querying Earn account balance when try to withdraw via Earn account

## 2026-03-26
### REST API
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - Add a new response field `xstockMultiplier`for category=spot, used for xstocks trading pairs.
- [Get Account Instruments Info](../v5/account/instrument) [UPDATE]
    - Add a new response field `xstockMultiplier`for category=spot, used for xstocks trading pairs.
- [Asset Overview](../v5/asset/balance/asset-overview) [UPDATE]
    - Add new request parameters `valuationCurrency` and `accountType`
    - Add new response field `extMap` (with `priceUpper`, `priceLower`, `equityUnit`) under `coinDetail` when `accountType=Alpha`
...
- [Advanced-Earn DualAssets APIs and WebSockets](../v5/finance/advanced-earn/dual-asset/product-info) [NEW]
    - We have launched Waanx Advanced-Earn DualAssets. Please see our [Product info](../v5/finance/advanced-earn/dual-asset/product-info) for details.

- [Get Mark Price Kline](../v5/market/mark-kline) [UPDATE]
    - Support options

## 2026-03-23
### REST API
- [Get Trade Quote](../v5/alpha/trade-quote) [NEW]
    - Add a new endpoint to get a price quote before executing an on-chain purchase or redeem trade
- [Execute Purchase](../v5/alpha/trade-purchase) [NEW]
    - Add a new endpoint to execute a buy order to purchase on-chain tokens with payment tokens (e.g. USDT)
- [Execute Redeem](../v5/alpha/trade-redeem) [NEW]
    - Add a new endpoint to execute a sell order to redeem on-chain tokens back to payment tokens
- [Get Payment Token List](../v5/alpha/pay-token-list) [NEW]
    - Add a new endpoint to query available payment tokens and their CEX token codes for on-chain trading
- [Get Order List](../v5/alpha/order-list) [NEW]
    - Add a new endpoint to query on-chain trade order history with status, fees, and execution details
- [Get Biz Token List](../v5/alpha/biz-token-list) [NEW]
    - Add a new endpoint to query on-chain tradable tokens with DEX token codes, risk flags, and order limits
- [Get Token Price List](../v5/alpha/biz-token-price-list) [NEW]
    - Add a new endpoint to batch query on-chain token prices, 24h change, volume, and market cap
- [Get Token Details](../v5/alpha/biz-token-details) [NEW]
    - Add a new endpoint to query token project details including description, social links, and risk flags
- [Get Asset List](../v5/alpha/asset-list) [NEW]
    - Add a new endpoint to query user's on-chain token portfolio with holdings, PnL, and market value
- [Get Asset Detail](../v5/alpha/asset-detail) [NEW]
    - Add a new endpoint to query detailed holding information for a specific on-chain token

## 2026-03-20
### REST API
- [Sign Agreement](../v5/user/sign-agreement) [UPDATE]
    - Add a new category=3 for crude oil perpetual agreement

## 2026-03-19
### WebSocket
- [Orderbook](../v5/websocket/public/orderbook) [UPDATE]
    - Spot Level 200 data push frequency changed from 200ms to 100ms

### REST API
- [Get Staked Position](../v5/finance/earn/easy-onchain/position) [UPDATE]
    - Add new response field `autoReinvest` to indicate whether auto-reinvest is enabled.
- [Modify Position](../v5/finance/earn/easy-onchain/modify-position) [NEW]
    - Add a new endpoint to modify the auto-reinvestment setting for OnChain Fixed positions
- [Get Yield History](../v5/finance/earn/easy-onchain/yield-history) [UPDATE]
    - `category` now supports `OnChain`
- [Get APR History](../v5/finance/earn/easy-onchain/apr-history) [NEW]
    - Add a new endpoint to query historical APR data for FlexibleSaving and OnChain products, supporting up to 6 months of history

## 2026-03-17
### WebSocket
- [Fast Execution](../v5/websocket/private/fast-execution) [UPDATE]
    - Fast Execution Support for Options

## 2026-03-13
### REST API
- [Get Currency Data](../v5/spot-margin-uta/currency-data) [NEW]
    - Add a new endpoint to query borrowing currency data, including flexible/fixed borrow availability, min borrow quantity, precision, and interest rate range

## 2026-03-12
### REST API
- [Set Delta Neutral Mode](../v5/account/set-delta-mode) [NEW]
    - Add a new endpoint to enable or disable Delta Neutral mode
- [Get Trade Behaviour Config](../v5/account/get-user-setting-config) [UPDATE]
    - Add new response field `deltaEnable` to indicate whether Delta Neutral mode is enabled
...
## 2026-03-06
### REST API
- [Asset Overview](../v5/asset/balance/asset-overview) [NEW]
...
## 2026-02-10
### REST API
- [Set Rate Limit](../v5/broker/exchange-broker/rate-limit/set) [NEW]
    - Add new endpoint to support exchange broker to set the rate limit for its sub account
- [Get Rate Limit Cap](../v5/broker/exchange-broker/rate-limit/query-cap) [NEW]
    - Add new endpoint to query the EB cap once specially configured.
- [Get All Rate Limits](../v5/broker/exchange-broker/rate-limit/query-all) [NEW]
...
- [Modify Master API Key](../v5/user/modify-master-apikey) [UPDATE]
    ...
    - For Read_Write apikey, adding or deleting FiatP2P, FiatWaanxPay, and FiatConvertBroker is prohibited.
- [Spot DMM Listing Integration](../institutional/dmm-listing/spot) [NEW]
...
## 2026-01-28
### REST API
- [Upgrade to Unified Account Pro](../v5/account/upgrade-unified-account) [UPDATE]
    - New threshold restrictions added for UTA users upgrading to PRO.

## 2026-01-16
### REST API
- [Obtain Max Loan Amount](../v5/new-crypto-loan/max-loan-amt) [NEW]
...
## 2026-01-06
### REST API
- [Set Auto Repay Mode](../v5/spot-margin-uta/set-auto-repay-mode) [NEW]
    - Add new endpoint to set spot automatic repayment mode
- [Get Auto Repay Mode](../v5/spot-margin-uta/get-auto-repay-mode) [NEW]
...
## 2025-12-24
### REST API
- [Fiat Convert](../v5/asset/fiat-convert/query-coin-list) [NEW]
    - Added Fiat Conversion Feature

## 2025-12-23
- [Convert Small Balances](../v5/asset/convert-small-balance/small-balanc-coins) [NEW]
    - Added Convert Small Balances Feature

## 2025-12-18
### REST API
- [Accept non-LP Quote](../v5/rfq/trade/accept-other-quote)[NEW]
    - Add new endpoint for accept non-LP Quote
- [Get RFQs (real-time)](../v5/rfq/trade/rfq-realtime)[UPDATE]
    - Add new response filed `acceptOtherQuoteStatus`
- [Get RFQs ](../v5/rfq/trade/rfq-list)[UPDATE]
    - Add new response filed `acceptOtherQuoteStatus`
- [Get ADL Alert](../v5/market/adl-alert) [UPDATE]
...
- [Manual Repay](../v5/account/repay) [UPDATE]
    - MNT will temporarily not be used for repayment, and repaying MNT liabilities through convert-repay is not supported. However, you may still use [Manual Repay Without Asset Conversion](/v5/account/no-convert-repay) to repay MNT using your existing balance.

### WebSocket API
- [ADL Alert](../v5/websocket/public/adl-alert) [UPDATE]
...
- [RFQ](../v5/rfq/websocket/private/inquiry) [UPDATE]
    - Add new response filed `acceptOtherQuoteStatus`

## 2025-12-16
- [SBE Level 50 Integration](../v5/sbe/market/level-50) [UPDATE]
    - SBE Level 50 for Futures will be released on the mainnet at **7:00 AM (UTC+0) on December 16th**

## 2025-12-02
### SBE API
- [SBE Basic Info](../v5/sbe/sbe-basic-info) [NEW]
    - Add SBE basic information description
- [SBE BBO Integration](../v5/sbe/market/bbo) [NEW]
...
- [SBE Level 50 Integration](../v5/sbe/market/level-50) [NEW]
    - Add SBE Level 50 market data endpoint
    - SBE Level 50 for Spot was released on the mainnet at **7:00 AM (UTC+0) on December 2nd**

## 2025-11-27
### REST API
- [Renew Borrow Order](../v5/new-crypto-loan/fixed/renew) [NEW]
    - Add new endpoint to Renew fixed crypto loan
- [Get Renew Order Info](../v5/new-crypto-loan/fixed/renew-order) [NEW]
...
- We have deprecated the Legacy Crypto Loan Borrow API, since the new crypto loan service is now online.
    - [Legacy Crypto Loan Borrow](../v5/abandon/borrow)
...
- [Get Public Trades](../v5/market/recent-trade) [UPDATE]
...
## 2025-11-03
### REST API
- [Manual Repay Without Asset Conversion](../v5/account/no-convert-repay) [NEW]
    - Add a new endpoint to manual repay without asset conversion

## 2025-10-23
### REST API
- [Manual Borrow](../v5/account/borrow) [NEW]
    - Add a new endpoint for UTA manual borrow

- [Get Max Borrowable Amount](../v5/spot-margin-uta/max-borrowable) [NEW]
    - Add a new endpoint to get max borrowable amount

- [Get Position Tiers](../v5/spot-margin-uta/position-tiers) [NEW]
...
- [Get Coin State](../v5/spot-margin-uta/coinstate) [NEW]
    - Add a new endpoint to get currency leverage information

- [Get Available Amount to Repay](../v5/spot-margin-uta/repayment-available-amount) [NEW]
...
## 2025-10-21
### REST API
- [Get Withdrawal Address List](../v5/asset/withdraw/withdraw-address) [NEW]
...
- [Get Account Instruments Info](../v5/account/instrument) [NEW]
...
- [Get Sub UID List (Unlimited)](../v5/user/page-subuid) [UPDATE]
    - Update response parameter `accountMode`, now support distinguish to Classic Account, UTA1.0, UTA1.0 Pro, UTA2.0, UTA2.0 Pro

## 2025-10-10
### REST API
- [RFQ APIs and WebSockets](../v5/rfq/basic-workflow) [NEW]
    - We have launched Waanx RFQ (Request for Quote). Please see our [basic workflow](../v5/rfq/basic-workflow) and the [help centre](https://waanx.com/en/help-center/article/Introduction-to-RFQ) for details.
- Earn API [NEW]
    - [Get Yield History](../v5/finance/earn/easy-onchain/yield-history)
    - [Get Hourly Yield History](../v5/finance/earn/easy-onchain/hourly-yield)
- Earn API [UPDATE]
    - [Get Stake/Redeem Order History](../v5/finance/earn/easy-onchain/order-history)
...
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - category=`spot` adds new response fields `maxLimitOrderQty`, `maxMarketOrderQty`, will becomes effective on Oct 16th, refer to the [announcement](https://waanx.com/article/changes-to-maximum-order-size-for-limit-and-market-orders-blt6ac479804a794c46/) to get more details

## 2025-09-28
### REST API
- [Rate Limit](../v5/rate-limit) [UPDATE]
    - [Set Rate Limit](/v5/rate-limit/rules-for-pros/apilimit-set)
        - Change the input parameter `limit` to `rate`, and change the returned field `limit` to `rate`.
    - [Get Rate Limit](/v5/rate-limit/rules-for-pros/apilimit-query)
        - Change returned field `limit` to `rate`.
- [Rate Limit](../v5/rate-limit) [NEW]
    - Add endpoints [Get Rate Limit Cap](/v5/rate-limit/rules-for-pros/apilimit-query-cap) and [Get All Rate Limits](/v5/rate-limit/rules-for-pros/apilimit-query-all)

## 2025-09-25
### REST API
- [Get Fee Group Structure](../v5/market/fee-group-info) [NEW]
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
...
## 2025-09-24
### REST API
- [Create Borrow Order](../v5/new-crypto-loan/fixed/borrow) [UPDATE]
    - Add a new input parameter `repayType`
- [Get Borrow Contract Info](../v5/new-crypto-loan/fixed/borrow-contract) [UPDATE]
    - Add a new response field `repayType`
- [Get Borrow Order Info](../v5/new-crypto-loan/fixed/borrow-order) [UPDATE]
    - Add a new response field `repayType`
...
- [Get Index Price Components](../v5/market/index-components) [NEW]
...
## 2025-09-18
### REST API
- [Get RPI Orderbook](../v5/market/rpi-orderbook) [NEW]
- [Get Open & Closed Orders](../v5/order/open-order) [UPDATE]
...
- [Order](../v5/spread/websocket/private/order) [UPDATE]
    - Add a new response field `cumFeeDetail` to return trading fee details instead of `cumExecFee` and `feeCurrency`
...
## 2025-09-11
### WebSocket API
- [Orderbook](../v5/websocket/public/orderbook) [REMOVE]
...
- [Get Repayment History](../v5/new-crypto-loan/flexible/repay-orders) [UPDATE]
    - Add a new repayType Enum `7: Repay by Currency` for current repayment records
...
- [Stake / Redeem](../v5/finance/earn/easy-onchain/create-order) [UPDATE]
...
## 2025-07-04
### REST API
- Add new api hostname `https://waanx.com` for Georgia users

### Websocket API
- Add new stream hostname `wss://waanx.com` for Georgia users
...
- [Get Sub Deposit Records (on-chain)](../v5/asset/deposit/sub-deposit-record) [UPDATE]
    - Add `id`, `txID` request parameters to filter deposit records
    - Add `id`, an internal unique key field in the response
- [Get Sub Account Deposit Records](../v5/broker/exchange-broker/sub-deposit-record) [UPDATE]
    - Add `id`, `txID` request parameters to filter deposit records
    - Add `id`, an internal unique key field in the response
- [Get Coin Information](../v5/asset/coin-info) [UPDATE]
...
## 2025-04-14
### REST API
- [Spread Trading API](../v5/spread/market/instrument) [NEW]

## 2025-04-11
### REST API
- [Earn API](https://waanx.com/docs/v5/finance/earn/easy-onchain/product-info) [UPDATE]
    - Add category `OnChain`.

## 2025-04-02
### REST API
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - Add request parameter `beneficiaryAddressCountry`, `beneficiaryAddressState`, `beneficiaryAddressCity` they are used for users from Waanx Indonesia to fill travel rule info

## 2025-04-01
### REST API
- [Place Order](../v5/order/create-order) [UPDATE]
    - "timeInForce" request parameter supports `RPI`, refer to [Retail Price Improvement (RPI) Order](https://waanx.com/en/help-center/article/Retail-Price-Improvement-RPI-Order) to get more details
...
- [Get Order History](../v5/order/order-list) [UPDATE]
    - Response field "timeInForce" supports `RPI`
- [Get Public Recent Trading History](../v5/market/recent-trade) [UPDATE]
...
### REST API
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - Add request parameter `beneficiaryLegalType`, `beneficiaryWalletType`, `beneficiaryUnhostedWalletType`, `beneficiaryPoiNumber`, `beneficiaryPoiType`, `beneficiaryPoiIssuingCountry`, `beneficiaryPoiExpiredDate` they are used for users from Waanx Turkey and Waanx Kazakhstan to fill travel rule info
...
### REST API
- Earn API [NEW]
    - [Get Product Info](../v5/finance/earn/easy-onchain/product-info)
    - [Stake / Redeem](../v5/finance/earn/easy-onchain/create-order)
    - [Get Stake/Redeem Order History](../v5/finance/earn/easy-onchain/order-history)
    - [Get Staked Position](../v5/finance/earn/easy-onchain/position)

### Websocket API
- [All Liquidation](../v5/websocket/public/all-liquidation) [NEW]
    - A new topic to get full liquidation occurred in Waanx exchange.
...
- [Get Collateral Info](../v5/account/collateral-info) [UPDATE]
    - The field `collateralRatio` field will be no longer useful due to the transition from a single conversion rate to a tiered collateral value ratio starting from 19 Feb, 2025, refer to [announcement](https://waanx.com/article/updates-to-collateral-value-ratio-rules-for-uta-borrowing-blteba1497739a08988/)
...
### REST API
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - For category=`spot`, replace `limitParameter` and `marketParamter` with `priceLimitRatioX`, `priceLimitRatioY`, please refer to this [change](https://waanx.com/article/title-adjustments-to-waanx-s-spot-trading-limit-order-mechanism-blt786c0c5abf865983/)

## 2025-01-09
### REST API
- [Get Sub Account Deposit Records (Exchange Broker)](../v5/broker/exchange-broker/sub-deposit-record) [UPDATE]
...
- [Get Exchange Broker Earning](../v5/broker/exchange-broker/exchange-earning) [UPDATE]
...
### REST API
- [Get Instruments Info](../v5/market/instrument) [UPDATE]
    - For category=`linear` and `inverse`, added response field `riskParameters`, `priceLimitRatioX`, `priceLimitRatioY`, please refer to this [change](https://waanx.com/article/adjustments-to-waanx-s-derivative-trading-limit-order-mechanism-blt469228de1902fff6/)
...
## 2024-11-05
- Kazakhstan users registered from "www.waanx.com", please use "api.waanx.com" and "stream.waanx.com" hostnames.
...
## 2024-10-15
### Websocket API
- Add websocket domain `stream.waanx.com` for the users registered with www.waanx.com. These users can now 
use this domain to place orders via [websocket trade service](../v5/websocket/trade/guideline).

## 2024-10-11
### REST API
- [Crypto Loan](../v5/crypto-loan/collateral-coin) APIs are released to production [NEW]
...
## 2024-08-06
### REST API
- [Demo Trading Service](../v5/demo#request-demo-trading-funds) [UPDATE]
...
- [Get Exchange Broker Account Info](../v5/broker/exchange-broker/account-info) [UPDATE]
    - Add new response fields `convert`
...
- [Get Transaction Log (Classic)](../v5/abandon/contract-transaction-log) [NEW]
...
## 2024-04-15
### REST API
- [Demo Trading Service](../v5/demo#request-demo-trading-funds) [NEW]
...
## 2024-04-03
### REST API
- [Get Sub Account Deposit Records](../v5/broker/exchange-broker/sub-deposit-record) [NEW]
    - Add a new endpoint for exchange broker user to query sub account deposit records
- [API adds support for Demo Trading](../v5/demo) [NEW]
...
## 2024-03-12
### REST API
- [Set Risk Limit](../v5/abandon/set-risk-limit) [Deprecate]
...
- [Get Withdrawal Records](../v5/asset/withdraw/withdraw-record) [UPDATE]
    ...
    - The withdrawal between Waanx account returns `txID`
...
- [Get Broker Earning](../v5/abandon/earning) [deprecated]
    - deprecated, replaced by [Get Exchange Broker Earning](../v5/broker/exchange-broker/exchange-earning)
- [Get Exchange Broker Earning](../v5/broker/exchange-broker/exchange-earning) [NEW]
    - Add a new endpoint to query exchange broker earning information
- [Get Exchange Broker Account Info](../v5/broker/exchange-broker/account-info) [NEW]
...
- [Withdraw](../v5/asset/withdraw) [UPDATE]
    - Add new enum value for `forceChain` parameter. You can withdraw between Waanx main accounts via inputting UID
...
## 2023-07-04
### REST API
- [Get Waanx Sever Time](../v5/market/time)
...
## 2023-05-10
### REST API
- [Set Risk Limit](../v5/abandon/set-risk-limit) [UPDATE]
...
- [Get Announcement](../v5/announcement) [NEW]
    - A brand new API to get Waanx announcements
...
- [Get Internal Deposit Records (across Waanx)](../v5/asset/deposit/internal-deposit-record) [NEW]
    - New api to get internal deposit on Waanx platform
