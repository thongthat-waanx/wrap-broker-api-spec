...
* Details: *Gradully change the settlement currency from USDC to USDT for linear Futures and Options, refer to [announcement](https://waanx.com/article/upcoming-changes-to-settlement-currencies-for-waanx-s-options-and-linear-expiry-futures-contracts-blt7a38862820dfad8b/)*
...
<a href="https://waanx.com/docs-legacy/usdc/option/#t-assetinfo">Set Margin Mode</a>
...
* Details: _Waanx will release uids that allow upgrades in batches starting from 23 June, and if you select to upgrade it, you can only use [V5](/v5/order/create-order) to copy trade_
...
and <a href="https://waanx.com/docs/usdc/option/#t-setmarginmode">V1-USDC Set Margin Mode</a>
* Details:
