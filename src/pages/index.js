      ...
      <div className="container">
        ...
        <p className={styles.heroSubtitle}>
          <Translate id="homepage.hero.subtitle">
            Build powerful trading applications with Waanx's unified V5 API.
...
export default function Home() {
  return (
    <Layout
      ...
      description="Build powerful trading applications with Waanx's unified V5 Open API. Access spot, derivatives, and options markets.">
      <main>
        <HomepageFeatures />
      </main>
      <HomepageHeader />
